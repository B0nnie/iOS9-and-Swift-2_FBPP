...
public class LinearProgressBar: UIView {
    ...
    public var progressBarColor: UIColor = UIColor(red:0.933, green:0.933, blue:0.933, alpha:1.0)
    ...
    public init () {
        ...
        //here
        self.progressBarIndicator = UIView(frame: CGRectMake(0, Constants.NAVIGATION_BAR_HEIGHT+1, 0, heightForLinearBar))
    ...
    private func configureAnimation() {
        //here
        self.progressBarIndicator.frame = CGRectMake(0, Constants.NAVIGATION_BAR_HEIGHT+1, 0, heightForLinearBar)
        
        UIView.animateWithDuration(0.5, delay:0, options: [], animations: {
            
            //here
            self.progressBarIndicator.frame = CGRect(x: 0, y: Constants.NAVIGATION_BAR_HEIGHT+1, width: self.widthForLinearBar*0.7, height: self.heightForLinearBar)
        ...
        UIView.animateWithDuration(0.4, delay:0.4, options: [], animations: {
            ...
            //here
            self.progressBarIndicator.frame = CGRect(x: self.frame.width, y: Constants.NAVIGATION_BAR_HEIGHT+1, width: 0, height: self.heightForLinearBar)
